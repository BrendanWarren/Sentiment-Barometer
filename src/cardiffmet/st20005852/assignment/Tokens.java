...
public class Tokens
{
	...
	static ProgressKeeper MyProgressKeeper = new ProgressKeeper();
	...
	void processTokens() throws FileNotFoundException, XPathExpressionException, ParserConfigurationException, SAXException, IOException, JWNLException
	{
		...
		Dictionary dictionary = Dictionary.getInstance(new FileInputStream("C:/Users/Brendan/Documents/University/OO Sys 2/workspace/Sentiment-Barometer/res/file_properties.xml"));
